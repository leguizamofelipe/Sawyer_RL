...
env = ContinuousArmMotionEnvironment(target_dict=target_dict, save_to_disk=True)
...
model = DDPG('MlpPolicy', env, action_noise=action_noise, verbose = 1, device = 'cuda:1')
